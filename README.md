...
Specifies the result type of predictions generated by the model. Defaults to `double`. See the [MLflow spark_udf API docs](https://www.mlflow.org/docs/latest/python_api/mlflow.pyfunc.html#mlflow.pyfunc.spark_udf) for more information. Defaults to `double`.


- `save_mode`: string. Optional:
Specifies the save mode used by Spark for writing data. See the [PySpark save modes documentation] for options. Defaults to `default`.
</details>
