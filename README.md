...
Specifies the data type for predictions generated by the model. See the [MLflow spark_udf API docs](https://www.mlflow.org/docs/latest/python_api/mlflow.pyfunc.html#mlflow.pyfunc.spark_udf) for more information.


- `save_mode`: string. Optional. Defaults to `default`.
Specifies the save mode used by Spark for writing the scored data. See the [PySpark save modes documentation](https://spark.apache.org/docs/latest/sql-data-sources-load-save-functions.html#save-modes) for more information.
</details>
